      ...
      <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div class="flex-1 text-center lg:text-left">
          ...
          <div
            ...
            <div class="text-center lg:text-left">
              ...
              <div
                class="text-fluid-xs text-ink-300 mt-1 uppercase tracking-widest">
                Case Studies
              </div>
            </div>
        ...
        <div
          ...
          <div
            ...
            <p class="text-fluid-xs text-ink-300 mt-0.5">
              Progressive Web App
            </p>
          </div>
            ...
            <div
              ...
              <div class="relative z-10">
                ...
                <h3
                  ...
                  <span class="text-flame-500 text-fluid-xl">Website Redesign &amp; Migration</span>
                </h3>
            ...
            <div
              ...
              <div class="relative z-10">
                ...
                <h3
                  ...
                  <span class="text-flame-500 text-fluid-xl">Brand &amp; Website Overhaul</span>
                </h3>
                <!-- PLACEHOLDER -->
                <p class="text-fluid-sm text-ink-300 leading-relaxed mb-6">
                  Vanity Fair Lingerie was undergoing a brand refresh to refocus their online marketing towards their new target audience. Our goal was to overhaul the site to bring in new customers and drive up sales.
                </p>
                <!-- PLACEHOLDER -->
                <div
                  class="flex items-center gap-3 mb-8 p-4 rounded-xl bg-ink-950 border border-ink-800">
            ...
            <div
              ...
              <div class="relative z-10">
                ...
                <h3
                  ...
                  class="font-heading font-bold text-fluid-3xl text-ink-50 leading-tight mb-4">
                  Russell Athletic<br />
                  <span class="text-flame-500 text-fluid-xl">Website Rebuild &amp; Refactor</span>
                </h3>
                <!-- PLACEHOLDER -->
                <p class="text-fluid-sm text-ink-300 leading-relaxed mb-6">
                  Russell Athletic was transitioning their online presence from an E-Commerce platform, to more of a brand showcase. My team was tasked with a complete redesign and code base restructuring. Moving to a headlless CMS for better performance and scalability.
                </p>
                <!-- PLACEHOLDER -->
                <div
                  class="flex items-center gap-3 mb-8 p-4 rounded-xl bg-ink-950 border border-ink-800">
                  ...
                  <div>
                    ...
                    <p class="text-fluid-xs text-ink-300">
                      Increase in Brand Partner Sales
                    </p>
                  </div>
                </div>
                <a href="case-study-template.php" class="btn-primary is-disabled">
            ...
            <div
              ...
              <div class="relative z-10">
                ...
                <h3
                  ...
                  class="font-heading font-bold text-fluid-3xl text-ink-50 leading-tight mb-4">
                  Spalding<br />
                  <span class="text-flame-500 text-fluid-xl">Website Refresh</span>
                </h3>
                <!-- PLACEHOLDER -->
                <p class="text-fluid-sm text-ink-300 leading-relaxed mb-6">
                  Spalding's original website was clunky and dated. Our redesign improved user experience, modernized the visual design, and enhanced overall brand presence online. All while bringing in new customers and launching new products.
                </p>
                <!-- PLACEHOLDER -->
                <div
                  class="flex items-center gap-3 mb-8 p-4 rounded-xl bg-ink-950 border border-ink-800">
        ...
        <article
          ...
          <div
            ...
            <div class="flex gap-2 hidden sm:block">
              ...
              <span class="skill-tag">AI - Claude</span>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-[3fr_2fr]">
            ...
            <div
              ...
              <div class="relative z-10">
                ...
                <!-- PLACEHOLDER -->
                <p class="text-fluid-sm text-ink-300 leading-relaxed mb-6">
                  What started as a simple task for a job application turned into a passion project for learning new skills. Originally asked to only create a UI for a simple Black Jack app, I wanted to take my concept and make it a reality.
                </p>
                <!-- PLACEHOLDER -->
                <div
                  class="flex items-center gap-3 mb-8 p-4 rounded-xl bg-ink-950 border border-ink-800">
                  ...
                  <div>
                    ...
                    <p class="text-fluid-xs text-ink-300">
                      Increase in Overall Fun While Playing
                    </p>
                  </div>
                </div>
  ...
  <section id="brands" class="section" aria-labelledby="brands-heading">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12 mb-14">
      <div class="text-center fade-in-up">
        ...
        <p class="section-subtitle max-w-2xl mx-auto">
          Over the course of my professional career I've had the opportunity to partner with a diverse range of brands. These are a few of the companies I've been fortunate to work with.
        </p>
      </div>
    </div>
      ...
      <div
        ...
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/my-star-brands.svg"
              alt="MyStarBrands"
              width="100%"
            />
          </div>
          <span class="logo-name">My Star Brands</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/jade-range.svg"
              alt="Jade Range"
              width="max-content"
            />
          </div>
          <span class="logo-name">Jade Range</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/fruit-logo.svg"
              alt="Fruit of the Loom"
              width="max-content"
            />
          </div>
          <span class="logo-name">Fruit of the Loom</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/russell-logo-wordmark.svg"
              alt="Russellc Athletic"
              width="max-content"
            />
          </div>
          <span class="logo-name">Russellc Athletic</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/spalding-logo-wordmark.svg"
              alt="Spalding"
              width="max-content"
            />
          </div>
          <span class="logo-name">Spalding</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/vfl-logo.svg"
              alt="Vanity Fair Lingerie"
              width="max-content"
            />
          </div>
          <span class="logo-name">Vanity Fair Lingerie</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/bakers-pride.svg"
              alt="Baker's Pride"
              width="100%"
            />
          </div>
          <span class="logo-name">Baker's Pride</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/turbochef.svg"
              alt="Turbochef"
              width="100%"
            />
          </div>
          <span class="logo-name">Turbochef</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/wisersites.svg"
              alt="Wiser Sites"
              width="100%"
            />
          </div>
          <span class="logo-name">Wiser Sites</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/follett.svg"
              alt="Follett"
              width="100%"
            />
          </div>
          <span class="logo-name">Follett</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/adcraft.svg"
              alt="Admiral Craft"
              width="100%"
            />
          </div>
          <span class="logo-name">Admiral Craft</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/southbend.webp"
              alt="Southbend"
              width="100%"
            />
          </div>
          <span class="logo-name">Southbend</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/synesso.svg"
              alt="Synesso"
              width="100%"
            />
          </div>
          <span class="logo-name">Synesso</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/newton.svg"
              alt="Newton Beverage Solutions"
              width="100%"
            />
          </div>
          <span class="logo-name">Newton Beverage Solutions</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/nieco.png"
              alt="Nieco"
              width="100%"
            />
          </div>
          <span class="logo-name">Nieco</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/lincat.svg"
              alt="Lincat"
              width="100%"
            />
          </div>
          <span class="logo-name">Lincat</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/savante.svg"
              alt="Savante"
              width="100%"
            />
          </div>
          <span class="logo-name">Savante</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/imperial.svg"
              alt="Imperial Range"
              width="100%"
            />
          </div>
          <span class="logo-name">Imperial Range</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/cafepress.svg"
              alt="CafePress"
              width="100%"
            />
          </div>
          <span class="logo-name">CafePress</span>
        </div>
        <div class="logo-item" role="listitem">
          <div class="logo-item-inner">
            <img
              src="dist/img/brand-logos/lily-of-france.webp"
              alt="Lily of France"
              width="100%"
            />
          </div>
          <span class="logo-name">Lily of France</span>
        </div>
