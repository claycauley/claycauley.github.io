  ...
  <section
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
      <div class="max-w-3xl">
        ...
        <p
          class="text-fluid-xl text-ink-300 leading-relaxed max-w-xl mb-10 fade-in-up"
          data-delay="2">
      ...
      <div class="flex flex-col lg:flex-row gap-5 lg:gap-5 items-start">
        ...
        <div class="flex-1 w-full min-w-0 fade-in-up">
          ...
          <div
            ...
            <div
              ...
              <p
                class="text-fluid-base text-ink-300 max-w-sm leading-relaxed">
              ...
              <div class="flex flex-col gap-6">
                ...
                <div class="contact-field">
                  ...
                  <div class="relative">
                    ...
                    <span
                      id="char-count"
                      class="absolute bottom-3 right-3 text-fluid-xs text-ink-300 font-heading font-medium pointer-events-none select-none"
                      aria-live="polite"
                      aria-atomic="true"
                      >0 / 2000</span>
                  </div>
                ...
                <p class="text-fluid-xs text-ink-300 leading-relaxed -mt-1">
                  <i
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener"
                    class="underline hover:text-flame-400 transition-colors"
                    >Privacy Policy</a>
                  and
                  <a
                ...
                <div
                  ...
                  <p
                    id="submit-status"
                    class="text-fluid-xs text-ink-300"
                    aria-live="polite"
                    aria-atomic="true"
                  ></p>
                </div>
        ...
        <div
          ...
          <div class="p-6 rounded-2xl bg-ink-900 border border-ink-800">
            ...
            <p class="text-fluid-sm text-ink-300 leading-relaxed mb-4">
              Open to freelance, contract, and full-time opportunities.
              Let's talk about how I can help.
            </p>
            <ul class="flex flex-col gap-2.5" role="list">
              <li
                class="flex items-center gap-3 text-fluid-xs text-ink-300">
                <i
          ...
          <div class="p-6 rounded-2xl bg-ink-900 border border-ink-800">
            ...
            <div class="flex items-center gap-3 group">
              ...
              <div>
                <p class="text-fluid-xs text-ink-300 mb-0.5">Email</p>
                <button
                  type="button"
                  data-copy-email="hello@claydesigns.cc"
                  class="relative inline-block font-heading font-semibold text-fluid-sm text-ink-200 hover:text-flame-400 transition-colors duration-200 text-left">
            ...
            <div class="flex flex-col gap-3">
              ...
              <a
                ...
                <div
                  ...
                  <i
                    class="fa-brands fa-linkedin-in text-ink-300 group-hover:text-[#0A66C2] transition-colors duration-200 text-xs"
                    aria-hidden="true"
                  ></i>
                </div>
                <span
                  class="font-heading font-semibold text-fluid-sm text-ink-300 group-hover:text-ink-100 transition-colors duration-200"
                  >LinkedIn</span>
              </a>
              <!-- <a href="#" class="flex items-center gap-3 group">
                <div
                  ...
                  <i
                    class="fa-brands fa-github text-ink-300 group-hover:text-ink-100 transition-colors duration-200 text-xs"
                    aria-hidden="true"
                  ></i>
                </div>
                <span
              ...
              <!-- <a href="#" class="flex items-center gap-3 group">
                <div
                  ...
                  <i
                    class="fa-brands fa-dribbble text-ink-300 group-hover:text-[#EA4C89] transition-colors duration-200 text-xs"
                    aria-hidden="true"
                  ></i>
                </div>
                <span
