    ...
    <div
      ...
      <div
        ...
        <div class="flex-1 text-center md:text-left">
          ...
          <p
            class="text-fluid-base text-ink-300 leading-relaxed mb-10 max-w-xl mx-auto md:mx-0 fade-in-up"
            data-delay="2">
  ...
  <section id="process" class="section" aria-labelledby="process-heading">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
      ...
      <div class="flex flex-col lg:flex-row lg:items-end gap-8 mb-14">
        ...
        <p
          class="lg:max-w-xs xl:max-w-sm text-fluid-base text-ink-300 leading-relaxed fade-in-up">
      ...
      <div
        ...
        <div class="relative text-center lg:text-left">
          ...
          <!-- PLACEHOLDER -->
          <p class="text-fluid-base text-ink-300">
