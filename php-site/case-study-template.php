...
<main id="main-content">
  ...
  <section
    ...
    <div class="absolute inset-0" aria-hidden="true">
      ...
      <img
        src="https://placehold.co/1920x1080/12100E/1F1614?text=Project+Hero+Image"
        alt=""
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <h1
          ...
          <span class="block text-fluid-display text-flame-500"
            >Goes Right Here</span>
        </h1>
        <!-- One-line tagline -->
        <!-- PLACEHOLDER: One sentence capturing what this project was -->
        <p
          class="text-fluid-xl text-ink-300 max-w-2xl mb-8 leading-relaxed">
          A compelling one-liner that captures the scope of this project,
          who it was for, and why it moved the needle.
        </p>
        <!-- Meta pills -->
      ...
      <div class="flex flex-col lg:flex-row gap-14 lg:gap-20 items-start">
        ...
        <div class="flex-1 fade-in-up">
          ...
          <p class="text-fluid-base text-ink-400 leading-[1.85] mb-6">
            ...
            picture of the "before" state so readers appreciate the gap
            between where things were and where they needed to be.
          </p>
          ...
          <blockquote
            ...
            <p
              ...
              "Replace this with a quote that captures the heart of the
              challenge — from the client brief, a discovery session, or
              your own insight going into the project."
            </p>
          </blockquote>
          ...
          <p class="text-fluid-base text-ink-400 leading-[1.85]">
            ...
            organizational? A thorough diagnosis is what separates good
            solutions from great ones.
          </p>
        </div>
        ...
        <div
          ...
          <div class="cs-gallery-item aspect-[4/3]">
            ...
            <img
              src="https://placehold.co/700x525/1F1614/2A1810?text=Context+Image"
