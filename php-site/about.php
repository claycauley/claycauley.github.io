          ...
          <div
            ...
            <ul class="flex flex-col gap-4" role="list">
              <li class="flex items-start gap-3">
                ...
                <div>
                  <p
                    class="text-fluid-xs text-ink-300 uppercase tracking-widest mb-0.5">
                    Role
                  </p>
                  <!-- PLACEHOLDER -->
          ...
          <div class="relative pl-10 border-l border-ink-800">
            ...
            <div class="relative mb-10 fade-in-up" data-delay="1">
              ...
              <div
                ...
                <div
                  ...
                  <span
                    class="shrink-0 text-fluid-xs text-ink-300 font-heading font-semibold bg-ink-800 px-3 py-1 rounded-full"
                    >2021 – 2025</span>
                </div>
                <!-- PLACEHOLDER -->
                <p class="text-fluid-sm text-flame-600 font-medium mb-3">
            ...
            <div class="relative fade-in-up" data-delay="3">
              <div
                ...
                aria-hidden="true">
                <i
                  class="fa-solid fa-graduation-cap text-ink-300 text-xs"
                ></i>
              </div>
              <div
                class="p-6 rounded-2xl bg-ink-900 border border-ink-800 hover:border-flame-500/30 transition-colors duration-300">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
      <div class="flex flex-col lg:flex-row gap-14 items-center">
        ...
        <div class="flex-1 fade-in-up">
          ...
          <p class="text-fluid-base text-ink-300 leading-relaxed">
        ...
        <div
          ...
          <div class="interest-tile group">
            ...
            <span
              ...
              >Gaming</span>
            <span class="text-fluid-xs text-ink-300 mt-1"
